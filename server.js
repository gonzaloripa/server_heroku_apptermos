                                        ...
                                        for (var q = 0; q < nombres.length; q++) {
                                          ...
                                          if(ok){
                                              ...
                                              if(file.title.substring(0,(file.title.length)-6) === (file_act.substring(0,(file_act.length)-6))) {                                            
                                                ...
                                                info[ind].push({image:{href:file.thumbnailLink.substring(0,(file_act.length)-4)+'s350',name:file.title,downloadUrl:"https://drive.google.com/uc?export=download&id="+file.id}}); //"https://drive.google.com/uc?export=view&id="                                            
                                              }else{
                                                  file_act=file.title;
                                                  ...
                                                  urls[ind].push("https://drive.google.com/uc?export=download&id="+file.id);
                                                  info[ind].push({image:{href:file.thumbnailLink.substring(0,(file_act.length)-4)+'s350',name:file.title,downloadUrl:"https://drive.google.com/uc?export=download&id="+file.id}}); //"https://drive.google.com/open?id="
                                                }
                                          } //end if ok
                                      }
                                      } //end for
